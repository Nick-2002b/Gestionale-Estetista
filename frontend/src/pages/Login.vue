    ...
    <div class="flex items-center justify-center bg-surface p-6">
      <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="flex bg-background p-1 rounded-lg mb-8">
          <button @click="toggleMode(true)" :class="['flex-1 py-2 rounded-md text-sm font-medium transition-all duration-200', isLogin ? 'bg-surface shadow-sm' : 'text-gray-500 hover:text-gray-700']">
            Accedi
          </button>
          <button
