  ...
  <Teleport to="body">
    <transition name="overlay">
      <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative w-full bg-surface rounded-2xl shadow-2xl overflow-hidden max-w-lg">
          <div class="flex items-center justify-between gap-4 p-6 border-b border-gray-200 bg-gray-50">
            <slot name="header">
