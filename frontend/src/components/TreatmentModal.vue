...
const emit = defineEmits(["close", "save", "addNewCategory"]);
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <div class="flex gap-2">
          ...
          <button type="button" @click="emit('addNewCategory')" class="px-4 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">+ Nuova</button>
        </div>
      </div>
